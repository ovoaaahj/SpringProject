	...
	<div class="shopMain">
		...
		<div class="shopMainCenterMenu">
			...
			<ul>
				...
				<li class="underline" id="sub1"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=싱글오리진">싱글오리진</a></li>
				<li class="underline" id="sub2"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=블렌드">블렌드</a></li>
				<li class="underline" id="sub3"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=스페셜티">스페셜티</a></li>
				<li class="underline" id="sub4"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=커피팩/선물세트">커피팩/선물세트</a></li>				
				<li class="underline" id="sub5"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=더치커피">더치커피</a></li>				
				<li class="underline" id="sub6"><a href="http://localhost:9000/project/shopMain3_2.do?kind1=coffee&&kind2=디카페인">디카페인</a></li>
			</ul>
